...
import Facturation from "@/components/Facture";
import ResumeFacture from "@/components/ResumeFacture";
    ...
    <>
      ...
      <div style={{ margin: 20 }}>
        <Breadcrumb>
          ...
          <Breadcrumb.Item href="/dashboard/depots">Dépots</Breadcrumb.Item>
...
export default ProtectedRoute(NouveauDevis);