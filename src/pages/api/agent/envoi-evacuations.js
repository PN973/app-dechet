...
const handler = async (req, res) => {
 if (req.method === "POST") {
  ...
  const { imageRecapitulatif, typeEvacuation, id, decheterie, dateEvacuation, heureEvacuation, immatriculation, nomChauffeur, numBenne, matieresEvacuees, peseeExutoire, typePesee, peseeEnEntree, peseeEnSortie, peseeNet, observations, listeImagesObservations, signatureOptimom } = req.body;
